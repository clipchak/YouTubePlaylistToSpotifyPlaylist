...
4. Find a YouTube playlist and collect its ID. The ID is the mix of characters after playlist?list= in the link of the YouTube playlist. 
   [playlistID](https://github.com/clipchak/YouTubePlaylistToSpotifyPlaylist/blob/master/images/playlistID.png)
